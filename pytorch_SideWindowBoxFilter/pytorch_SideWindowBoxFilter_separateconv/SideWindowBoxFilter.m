...
for ch=1:size(im,3)
    ...
    for i = 1:iteration
        ...
        d(:,:,1) = conv2(rot90(k_L,2), rot90(k_L,2), U,'same')-U;
        d(:,:,2) = conv2(rot90(k_L,2), rot90(k_R,2), U,'same')-U;
        d(:,:,3) = conv2(rot90(k_R,2), rot90(k_L,2), U,'same')-U;
        d(:,:,4) = conv2(rot90(k_R,2), rot90(k_R,2), U,'same')-U;
        d(:,:,5) = conv2(rot90(k_L,2), rot90(k,2), U,'same')-U;
        d(:,:,6) = conv2(rot90(k_R,2), rot90(k,2), U,'same')-U;
        d(:,:,7) = conv2(rot90(k,2), rot90(k_L,2), U,'same')-U;
        d(:,:,8) = conv2(rot90(k,2), rot90(k_R,2), U,'same')-U;
